...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_link = 'https://samplelink.com/recipe.pdf'
    ...
    def test_update_user_returns_error(self):
        """Test that updating user field returns an error"""
    ...
    def test_delete_other_users_recipe_error(self):
        """Test that authenticated user cannot delete other user's recipe"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Prawns'}, {'name': 'Curry leaves'}],
        }
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': '4.50',
            'ingredients': [{'name': 'Prawns'}, {'name': 'Rice'}],
        }
    ...
    def test_create_ingredient_on_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingredient = Ingredient.objects.get(name='Salt', user=self.user)
    ...
    def test_clear_recipe_ingredients(self):
        """Test clearing all ingredients when updating a recipe"""
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai prawn curry')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai prawn curry')
        r2 = create_recipe(user=self.user, title='Aloo Gobi')
        i1 = Ingredient.objects.create(user=self.user, name='Prawns')
        i2 = Ingredient.objects.create(user=self.user, name='Potato')
